...
def _build_model_from_experiment_config(
    ...
    return RedLampBaseline(**model_kwargs)


def test_redlamp_cnn_rerun_configs_load_and_enable_balanced_sampling() -> None:
    experiment_config_paths = [
        "configs/experiment/baseline/smd__redlamp_baseline__redlamp-cnn-baseline-window20-balanced__w20__seed11__default.yaml",
        "configs/experiment/scale/smd__redlamp_baseline__redlamp-cnn-baseline-machine-2-1-window20-adamw-cosine-val-vus-pr__w20__seed68__default.yaml",
        "configs/experiment/smoke/smd__redlamp_baseline__redlamp-cnn-baseline-machine-2-1-window20-adamw-cosine-val-vus-pr-smoke__w20__seed11__smoke.yaml",
    ]
