...
def test_iforest_window_baseline_fits_calibrates_and_scores() -> None:
    ...
    baseline = IForestWindowBaseline(window_size=10, n_estimators=20)
    ...
    assert calibration["method_metadata"]["anomaly_score_sign"] == (
