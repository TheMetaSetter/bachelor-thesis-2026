...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--file_lsit", type=str, default="../Datasets/File_List/TSB-AD-M-Eva.csv"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="number of optimization steps for test time adaptation",
    )
    parser.add_argument(
        "--gating_init",
        type=float,
        default=0.5,
        help="initial value of gating parameter",
    )
    parser.add_argument(
        "--batch_size", type=int, default=64, help="initial value of batch size"
    )
    parser.add_argument(
        "--win_size", type=int, default=10, help="initial value of window size"
    )
    ...
    for filename in file_list:
        ...
        if args.AD_Name in Semisupervise_AD_Pool:
            output = run_Semisupervise_AD(
                args.AD_Name, data_train, data, **Optimal_Det_HP
            )
