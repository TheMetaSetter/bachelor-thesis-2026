...
_C.TEST.TTA.CANDI.GATING_INIT = (
    0.0  # Initial value for the gating parameter in CANDI adapter
)
_C.TEST.TTA.CANDI.MIN_SAMPLES = 16
_C.TEST.TTA.CANDI.USE_HARD = True  # Whether to use hard samples in CANDI adapter
_C.TEST.TTA.CANDI.USE_MODERATE = (
    True  # Whether to use moderate samples in CANDI adapter
)
