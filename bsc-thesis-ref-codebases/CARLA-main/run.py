...
all_files = os.listdir(
    os.path.join("/home/zahraz/hz18_scratch/zahraz/datasets/", "SMD/train")
)
    ...
    if filename != "GECCO":
        ...
        subprocess.run(
            [
                ...
                "configs/env.yml",
                "--config_exp",
                "configs/pretext/carla_pretext_smd.yml",
                "--fname",
                filename,
            ],
            check=True,
        ...
        subprocess.run(
            [
                ...
                "configs/env.yml",
                "--config_exp",
                "configs/classification/carla_classification_smd.yml",
                "--fname",
                filename,
            ],
            check=True,
