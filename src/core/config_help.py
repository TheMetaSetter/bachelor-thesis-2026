...
def build_config_help_text(command_name: str) -> str:
    return dedent(
        ...
        5) Useful commands
          ...
          - Train:
              python scripts/train.py --experiment-config configs/experiment/smd_redlamp_mlp_baseline_window20.yaml
          - Evaluate:
              python scripts/evaluate.py --experiment-config configs/experiment/smd_redlamp_mlp_baseline_window20.yaml --checkpoint-path outputs/.../best.pt
        """
    ).strip()
