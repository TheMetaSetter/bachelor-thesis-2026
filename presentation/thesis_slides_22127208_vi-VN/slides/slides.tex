...
\begin{frame}{SMD là gì?}
  \centering
  {\LARGE\bfseries SMD}\par
  \small Server Machine Dataset\par
  \vspace{0.35em}
  {\large Dữ liệu cảm biến ghi lại trạng thái của máy chủ theo thời gian.}

  \vspace{1em}
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.56\textwidth}
      \centering
      \begin{tikzpicture}[x=0.58cm,y=0.48cm,>=Latex]
        \draw[->] (0,0) -- (8,0) node[right,font=\scriptsize]{thời gian};
        \draw[blue!65!black,thick] plot coordinates
          {(0,2.0) (1,2.2) (2,1.9) (3,2.3) (4,2.1) (5,2.4) (6,2.2) (7,3.0) (8,2.3)};
        \draw[green!50!black,thick] plot coordinates
          {(0,1.0) (1,1.1) (2,0.9) (3,1.2) (4,1.0) (5,1.1) (6,1.0) (7,1.1) (8,1.0)};
        \draw[orange!85!black,thick] plot coordinates
          {(0,0.1) (1,0.2) (2,0.1) (3,0.3) (4,0.2) (5,0.2) (6,0.3) (7,0.2) (8,0.3)};
        \fill[red!70!black] (7,3.0) circle (2pt);
        \node[red!70!black,above,font=\scriptsize] at (7,3.0) {bất thường};
      \end{tikzpicture}
    \end{column}
    \begin{column}{0.36\textwidth}
      \begin{exampleblock}{\centering Ba máy chủ}
        \centering
        \texttt{machine-1-6}\\[0.35em]
        \texttt{machine-3-4}\\[0.35em]
        \texttt{machine-3-9}
      \end{exampleblock}
    \end{column}
  \end{columns}
